...
predict(single_lmfit, test_data2) #predict the outcome Y from the single predictor linear model (Y v. dose)
single_aug <- 
  augment(single_lmfit, test_data2) # add columns of interest to new data frame
single_aug %>%
...
predict(full_lmfit, test_data2) #predict the outcome Y from the FULL predictor linear model (Y v. all predictors)
full_aug <- 
  augment(full_lmfit, test_data2) # add predictions to new data frame
full_aug %>%
...
predict(blank_fit, test_data2) #predict the outcome Y from the BLANK predictor linear model
blank_aug <- 
  augment(blank_fit, test_data2) # add predictions to new data frame
blank_aug %>%
  select("Y", "DOSE", "AGE", "SEX", "WT", "HT") # select columns to add to the data frame
