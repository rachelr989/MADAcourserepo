...
#### Third model fit
# fit linear model using height as outcome, Hair color and Hair count as predictors
# put the linear model into a data frame with tidy
# printed table 3 to check

lmfit3 <- lm(Height ~ Haircolor + Haircount, d4)  
